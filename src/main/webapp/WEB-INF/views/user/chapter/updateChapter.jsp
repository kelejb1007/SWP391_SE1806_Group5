                        ...
                        <div class="default--zRToH bc_fff">
                            <div class="form-container">
                                ...
                                <form class="ant-form ant-form-vertical setting_form--R6kRQ" action="<%= request.getContextPath()%>/updateChapter" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="ant-form-item-control-input-content">
                                                <span class="ant-input-affix-wrapper" style="border-radius: 8px;">
                                                    <input name="chapterNumber" id="chapterNumber" class="ant-input ant-input-lg" 
                                                           type="number" value="<%= chapter.getChapterNumber()%>" readonly>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="ant-form-item-control-input-content">
                                                <span class="ant-input-affix-wrapper" style="border-radius: 8px;">
                                                    <input name="chapterName" id="chapterName" class="ant-input ant-input-lg" 
                                                           type="text" value="<%= chapter.getChapterName()%>" required>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="ant-form-item-control-input-content">
                                                <span class="ant-input-affix-wrapper">
                                                    <textarea name="chapterContent" id="chapterContent" class="ant-input" 
                                                              placeholder="Type the chapter content here" required>${chapterContent}</textarea>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <!-- Submit, Reset và Back Buttons -->
                                    <button type="submit" class="ant-btn ant-btn-primary ant-btn-lg button--4vWlZ"><span>Update Chapter</span></button>
                                    <button type="reset" class="ant-btn ant-btn-primary ant-btn-lg button--4vWlZ" style="margin-left: 10px;"><span>Reset</span></button>
