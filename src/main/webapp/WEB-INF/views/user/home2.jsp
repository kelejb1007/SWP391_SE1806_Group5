                                        ...
                                        <ul>
                                            <c:forEach var="novel" items="${listHot}" varStatus="status">
                                                <li data-rid="${status.index + 1}">
                                                    <div class="book-img">
                                                        <a href="novel-detail?id=${novel.novelID}" data-eid="qd_F23" data-bid="${novel.novelID}" target="_blank">
                                                    ...
                                                    <div class="book-info">
                                                        <h4>
                                                            <a href="novel-detail?id=${novel.novelID}" data-eid="qd_F24" data-bid="${novel.novelID}" target="_blank" title="${novel.novelName}">${novel.novelName}</a>
                                                        </h4>
                                                        <p>${novel.novelDescription}</p>
                                                        <div class="state-box cf">
                                                            
                                                            <a class="author default" data-eid="qd_F25" target="_blank">
