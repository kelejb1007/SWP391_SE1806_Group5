                                ...
                                <div class="ant-spin-nested-loading">
                                    <div class="ant-spin-container">
                                        <div class="default--zRToH bc_fff ">
                                            <div class="ant-spin-nested-loading">
                                                <div class="ant-spin-container">
                                                    <form class="ant-form ant-form-vertical setting_form--R6kRQ">
                                                        ...
                                                        <div class="ant-form-item  item--1wVCg">
                                                            <div class="ant-row ant-form-item-row">
                                                                <div class="ant-col ant-form-item-label"><label for="bookTitle" class="ant-form-item-required" title="">
                                                                        <div class="dib"><span>Book name</span></div>
                                                                    </label></div>
                                                                <div class="ant-col ant-form-item-control">
                                                                    <div class="ant-form-item-control-input">
                                                                        <div class="ant-form-item-control-input-content"><span class="ant-input-affix-wrapper ant-input-affix-wrapper-lg" style="border-radius: 8px;">
                                                                                <input data-report-uiname="bookTitle" maxlength="70" placeholder="Within 70 characters" id="bookTitle" aria-required="true" class="ant-input ant-input-lg" type="text" value=""><span class="ant-input-suffix"><span class="ant-input-clear-icon ant-input-clear-icon-hidden" role="button" tabindex="-1"><span role="img" aria-label="close-circle" class="anticon anticon-close-circle"><svg fill-rule="evenodd" viewBox="64 64 896 896" focusable="false" data-icon="close-circle" width="1em" height="1em" fill="currentColor" aria-hidden="true">
                                                                ...
                                                                <div class="ant-col ant-form-item-control">
                                                                    <div class="ant-form-item-control-input">
                                                                        <div class="ant-form-item-control-input-content">
                                                                            <div aria-required="true" class="ant-radio-group ant-radio-group-outline ant-radio-group-large" id="freeType"><label class="ant-radio-wrapper ant-radio-wrapper-checked ant-radio-wrapper-in-form-item"><span class="ant-radio ant-radio-checked"><input class="ant-radio-input" type="radio" value="5" checked=""><span class="ant-radio-inner"></span></span><span>novel</span></label><label class="ant-radio-wrapper ant-radio-wrapper-in-form-item"><span class="ant-radio"><input class="ant-radio-input" type="radio" value="8"><span class="ant-radio-inner"></span></span><span>fan-fic</span></label></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="ant-form-item  item--1wVCg">
                                                            <div class="ant-row ant-form-item-row">
                                                                <div class="ant-col ant-form-item-label"><label for="gender" class="ant-form-item-required" title="leading gender">leading gender</label></div>
                                                                <div class="ant-col ant-form-item-control">
                                                                    <div class="ant-form-item-control-input">
                                                                        <div class="ant-form-item-control-input-content">
                                                                            <div aria-required="true" class="ant-radio-group ant-radio-group-outline ant-radio-group-large" id="gender"><label class="ant-radio-wrapper ant-radio-wrapper-in-form-item"><span class="ant-radio"><input class="ant-radio-input" type="radio" value="1"><span class="ant-radio-inner"></span></span><span>Male Oriented</span></label><label class="ant-radio-wrapper ant-radio-wrapper-in-form-item"><span class="ant-radio"><input class="ant-radio-input" type="radio" value="2"><span class="ant-radio-inner"></span></span><span>Female Oriented</span></label></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="ant-form-item  item--1wVCg">
                                                            <div class="ant-row ant-form-item-row">
                                                                <div class="ant-col ant-form-item-label"><label for="categoryId" class="ant-form-item-required" title="GENRE">GENRE</label></div>
                                                                <div class="ant-col ant-form-item-control">
                                                                    <div class="ant-form-item-control-input">
                                                                        <div class="ant-form-item-control-input-content">
                                                                            <div class="ant-select ant-select-lg ant-select-in-form-item select_border_radius---DfH7 undefined ant-select-single ant-select-show-arrow ant-select-disabled" aria-describedby="categoryId_extra" aria-required="true">
                                                                                <div class="ant-select-selector"><span class="ant-select-selection-search"><input type="search" id="categoryId" disabled="" autocomplete="off" class="ant-select-selection-search-input" role="combobox" aria-expanded="false" aria-haspopup="listbox" aria-owns="categoryId_list" aria-autocomplete="list" aria-controls="categoryId_list" aria-activedescendant="categoryId_list_0" aria-describedby="categoryId_extra" aria-required="true" readonly="" unselectable="on" value="" style="opacity: 0;"></span><span class="ant-select-selection-item" title="Select">Select</span></div><span class="ant-select-arrow" unselectable="on" aria-hidden="true" style="user-select: none;"><span role="img" aria-label="down" class="anticon anticon-down ant-select-suffix"><svg viewBox="64 64 896 896" focusable="false" data-icon="down" width="1em" height="1em" fill="currentColor" aria-hidden="true">
                                                                                        <path d="M884 256h-75c-5.1 0-9.9 2.5-12.9 6.6L512 654.2 227.9 262.6c-3-4.1-7.8-6.6-12.9-6.6h-75c-6.5 0-10.3 7.4-6.5 12.7l352.6 486.1c12.8 17.6 39 17.6 51.7 0l352.6-486.1c3.9-5.3.1-12.7-6.4-12.7z"></path>
                                                                                        </svg></span></span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div id="categoryId_extra" class="ant-form-item-extra"><span class="c_danger fs14">Please select leading gender first</span></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="ant-form-item  item--1wVCg">
                                                            <div class="ant-row ant-form-item-row">
                                                                <div class="ant-col ant-form-item-label"><label for="language" class="" title="language">language</label></div>
                                                                <div class="ant-col ant-form-item-control">
                                                                    <div class="ant-form-item-control-input">
                                                                        <div class="ant-form-item-control-input-content">
                                                                            <div class="ant-select ant-select-lg ant-select-in-form-item select_border_radius---DfH7 undefined ant-select-single ant-select-show-arrow">
                                                                                <div class="ant-select-selector"><span class="ant-select-selection-search"><input type="search" id="language" autocomplete="off" class="ant-select-selection-search-input" role="combobox" aria-haspopup="listbox" aria-owns="language_list" aria-autocomplete="list" aria-controls="language_list" aria-activedescendant="language_list_0" readonly="" unselectable="on" value="" style="opacity: 0;"></span><span class="ant-select-selection-item" title="English">English</span></div><span class="ant-select-arrow" unselectable="on" aria-hidden="true" style="user-select: none;"><span role="img" aria-label="down" class="anticon anticon-down ant-select-suffix"><svg viewBox="64 64 896 896" focusable="false" data-icon="down" width="1em" height="1em" fill="currentColor" aria-hidden="true">
                                                                                        <path d="M884 256h-75c-5.1 0-9.9 2.5-12.9 6.6L512 654.2 227.9 262.6c-3-4.1-7.8-6.6-12.9-6.6h-75c-6.5 0-10.3 7.4-6.5 12.7l352.6 486.1c12.8 17.6 39 17.6 51.7 0l352.6-486.1c3.9-5.3.1-12.7-6.4-12.7z"></path>
                                                                                        </svg></span></span>
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div class="ant-form-item  item--1wVCg">
                                                            <div class="ant-row ant-form-item-row">
                                                                <div class="ant-col ant-form-item-label"><label for="synopsis" class="" title="synopsis">synopsis</label></div>
                                                                <div class="ant-col ant-form-item-control">
                                                                    <div class="ant-form-item-control-input">
                                                                        <div class="ant-form-item-control-input-content"><textarea data-report-uiname="synopsis" placeholder="Type something seriously, wonderful synopsis can attract more readers" id="synopsis" class="ant-input" style="height: 53.6px; resize: none; min-height: 53.6px;"></textarea></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
