                                        ...
                                        <table class="table table-bordered table-striped table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Month</th>
                                                    <th>Week</th>
                                                    <th>Total Novels Posted</th>
                                                    <th>Total Novels Posted Last Month</th>
                                                    <th>Total Novels Posted This Month</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <c:forEach var="stat" items="${postedStatistics}">
                                                    <tr>
                                                        <td>${stat.year}</td>
                                                        <td>${stat.month}</td>
                                                        <td>${stat.week}</td>
                                                        <td>${stat.totalNovelsPosted}</td>
                                                        <td>${stat.totalNovelsPostedLastMonth}</td>
                                                        <td>${stat.totalNovelsPostedThisMonth}</td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="table table-bordered table-striped table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Month</th>
                                                    <th>Week</th>
                                                    <th>Total Novels Read</th>
                                                    <th>Total Novels Read Last Month</th>
                                                    <th>Total Novels Read This Month</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <c:forEach var="stat" items="${readStatistics}">
                                                    <tr>
                                                         <td>${stat.year}</td>
                                                        <td>${stat.month}</td>
                                                        <td>${stat.week}</td>
                                                        <td>${stat.totalNovelsRead}</td>
                                                        <td>${stat.totalNovelsReadLastMonth}</td>
                                                        <td>${stat.totalNovelsReadThisMonth}</td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
