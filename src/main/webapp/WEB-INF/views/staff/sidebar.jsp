            ...
            <div class="sidebar-nav navbar-collapse">
                ...
                <ul class="nav fix" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="${pageContext.request.contextPath}/managerStatisticsController?action=novelStatistics
                                   ">View statistics on novel</a>
                            </li>
                            
                            <li>
                                <a href="${pageContext.request.contextPath}/managerStatisticsController?action=accountStatistics
                                   ">View statistics on account</a>
                            </li>
                        </ul>
