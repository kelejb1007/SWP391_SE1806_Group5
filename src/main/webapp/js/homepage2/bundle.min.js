...
var Sentry = function (t) {
    ...
    var E, S = ["debug", "info", "warn", "error", "log", "assert", "trace"];
    function $(t, n = 0) {
    ...
    function et() {
        ...
        var r = n && n.getRandomValues ? () => n.getRandomValues(new Uint8Array(1))[0] : () => 16 * Math.random();
    ...
    function ct(t, n = 3, e = 102400) {
        var r, i = at(t, n);
        return r = i,
                function (t) {
                    return ~-encodeURI(t).split(/%..|./).length
                }(JSON.stringify(r)) > e ? ct(t, n - 1, e) : i
    }
    ...
    class dt {
        ...
        __init3() {
            this.u = t => {
                this.v(ht.RESOLVED, t)
            }
        }
        __init4() {
            this.h = t => {
                this.v(ht.REJECTED, t)
            }
        }
        __init5() {
            this.v = (t, n) => {
                this.i === ht.PENDING && (v(n) ? n.then(this.u, this.h) : (this.i = t,
                        this.p = n,
                        this.l()))
            }
        }
        __init6() {
            this.l = () => {
                if (this.i !== ht.PENDING) {
                    var t = this.o.slice();
                    this.o = [],
                            t.forEach((t => {
                                t[0] || (this.i === ht.RESOLVED && t[1](this.p),
                                        this.i === ht.REJECTED && t[2](this.p),
                                        t[0] = !0)
                            }
                            ))
                }
        ...
        return {
            ...
            add: function (r) {
                if (!(void 0 === t || n.length < t))
                    return vt(new m("Not adding Promise because buffer limit was reached."));
                var i = r();
    ...
    class Ct {
        ...
        q(t) {
            var n;
            t.fingerprint = t.fingerprint ? (n = t.fingerprint,
                    Array.isArray(n) ? n : [n]) : [],
    ...
    function Jt(t, n = {}) {
        var e = "string" == typeof n ? n : n.tunnel
    ...
    class Zt {
        ...
        captureEvent(t, n, e) {
            if (n && n.originalException && ut(n.originalException))
                return;
            let r = n && n.event_id;
        ...
        setupIntegrations() {
            var t, n;
            this.st() && !this.V && (this.G = (t = this.tt.integrations,
                    n = {},
                    t.forEach((t => {
                        n[t.name] = t,
        ...
        sendEvent(t, n = {}) {
            if (this.nt) {
                let r = Gt(t, this.nt, this.tt.K, this.tt.tunnel);
                for (var e of n.attachments || [])
                    r = $t(r, jt(e, this.tt.transportOptions && this.tt.transportOptions.textEncoder));
                this.ut(r)
        }
        }
        sendSession(t) {
        ...
        lt(t, n, e) {
            ...
            var r = {
                ...
                ...t.contexts && {
                        contexts: at(t.contexts, n, e)
                },
                ...t.extra && {
                        extra: at(t.extra, n, e)
                }
            };
            return t.contexts && t.contexts.trace && r.contexts && (r.contexts.trace = t.contexts.trace,
                    t.contexts.trace.data && (r.contexts.trace.data = at(t.contexts.trace.data, n, e))),
                    t.spans && (r.spans = t.spans.map((t => (t.data && (t.data = at(t.data, n, e)),
                                t)))),
                    r
        }
        ft(t) {
        ...
        vt(t, n, e) {
            ...
            if (!this.st())
                return vt(new m("SDK not enabled, will not capture event.", "log"));
            var s = "transaction" === t.type;
            return !s && "number" == typeof i && Math.random() > i ? (this.recordDroppedEvent("sample_rate", "error"),
                    vt(new m(`Discarding event because it's not included in the random sample (sampling rate = ${i})`, "log"))) : this.ct(t, n, e).then((e => {
                if (null === e)
                    throw this.recordDroppedEvent("event_processor", t.type || "error"),
                            new m("An event processor returned null, will not send event.", "log");
                ...
                if (null === r)
                    throw this.recordDroppedEvent("before_send", t.type || "error"),
                            new m("`beforeSend` returned `null`, will not send event.", "log");
    ...
    function tn(t, n, e = pt(t.bufferSize || 30)) {
        let r = {};
        return {
            send: function (i) {
                var s = [];
        ...
        constructor(t) {
            t.K = t.K || {},
                    ...
                    t.sendClientReports && xn.document && xn.document.addEventListener("visibilitychange", (() => {
                        "hidden" === xn.document.visibilityState && this.yt()
                    }
                    ))
        }
    ...
    const Rn = /^\s*at (?:(.*\).*?|.*?) ?\((?:address at )?)?((?:file|https?|blob|chrome-extension|address|native|eval|webpack|<anonymous>|[-a-z]+:|.*bundle|\/)?.*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i
            ...
            , Cn = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:file|https?|blob|chrome|webpack|resource|moz-extension|safari-extension|safari-web-extension|capacitor)?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js)|\/[\w\-. /=]+)(?::(\d+))?(?::(\d+))?\s*$/i
    ...
    function Gn(t, n = {}, e) {
        ...
        const sentryWrapped = function () {
            ...
            try {
                ...
                throw Kn(),
                        Xt((e => {
                            e.addEventProcessor((t => (n.mechanism && (st(t, void 0, void 0),
                                        ot(t, n.mechanism)),
                                        t.extra = {
                                            ...t.extra,
                                            arguments: r
    ...
    class re {
        ...
        setupOnce() {
            const t = e();
            this.tt.setTimeout && O(t, "setTimeout", ie),
                    this.tt.setInterval && O(t, "setInterval", ie),
                    this.tt.requestAnimationFrame && O(t, "requestAnimationFrame", se),
                    this.tt.XMLHttpRequest && "XMLHttpRequest"in t && O(XMLHttpRequest.prototype, "send", oe);
            const n = this.tt.eventTarget;
            if (n) {
